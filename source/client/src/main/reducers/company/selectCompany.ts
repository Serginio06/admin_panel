...
import {ISelectCompanyAction} from "../../actions/company/selectCompany";
...
export const selectCompanyReducer = (state: IState, action: ISelectCompanyAction): IState => {
    const companyId: string = action.companyId;
    ...
    let isEditable: boolean = state.companyPageState.isEditable;
